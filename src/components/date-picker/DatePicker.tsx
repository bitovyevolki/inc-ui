...
export function DatePicker({ label, error, disabled, date, onSelect }: IDatePickerProps) {
  return (
    <div className={s.container}>
      ...
      <Popover.Root>
        ...
        <Popover.Content className={s.PopoverContent} align="start">
...
const CalendarIcon = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_348_7032)">
        <path
