...
export const Header = ({isAuth, signInSrc, signUpSrc, title, onLanguageChange, selectedLanguage}:HeaderProps) => {
    ...
    return isAuth ? (
        ...
        <header className={s.header}>
            ...
            <div className={s.actions}>
                ...
                <Typography variant={'link1'} as={'a'} href={signInSrc} className={s.loginButton}>{'Login'}</Typography>
                <Button  as={'a'} href={signUpSrc} variant={'primary'}>{'Sing Up'}</Button>
            </div>
